    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col items-center justify-center gap-4 lg:flex-row">
        <Card
          ...
          icon={<MagicButton title="🔍 Strategic Planning" asChild />}
          description="At TOWNHALL, every project starts with deep discovery. We understand your goals, define user journeys, and create a strong roadmap tailored to your business vision."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          icon={<MagicButton title="🛠️ Design & Development" asChild />}
          description="Our team brings ideas to life with stunning UI/UX and robust engineering — using cutting-edge technologies to build responsive, scalable, and efficient digital solutions."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          icon={<MagicButton title="🚀 Deployment & Launch" asChild />}
          description="We ensure smooth deployment with DevOps best practices, automated CI/CD, and cloud integration — delivering a seamless launch experience with post-deployment support."
        >
          <CanvasRevealEffect
            animationSpeed={3}
